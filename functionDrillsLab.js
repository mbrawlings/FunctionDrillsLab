...
console.log((exclaimTwo('my name')))
...
let nameGreeting = nameCheck('Matt')
...
//CODE HERE
let bestMovie = (title) => console.log(`${title} is the best movie ever!`)
bestMovie('Mannequin') 
...
//CODE HERE
function theEliminator(allNames, loserName) {
  for (let i = 0; i < allNames.length; i++) {
    if (allNames[i] === loserName) {
      allNames.splice([i], 1)
      return allNames
    }
  }
...
function myFunction(someString) {
  return console.log(someString.toUpperCase())
}
...
emailCheck('thisIsMyEmail@yahoo.com')
...
function frogBuyer(goldAmt) {
  frogCost = 3
  return goldAmt / frogCost
}

let totalFrogs = frogBuyer(usableGold)

console.log(`I was able to buy ${totalFrogs} chocolate frogs`)
...
let totalFrogs2 = frogBuyer(usableGold)

console.log(`I was able to buy ${Math.floor(totalFrogs2)} chocolate frogs`)
